...
Float SpectrumBase::averageSamples(const Float *lambda, const Float *values, int n, Float lambdaStart,
                                   Float lambdaEnd)
{
...
const Float SpectrumBase::CIE_lambda[nCIESamples] = {
...
const Float SpectrumBase::CIE_X[nCIESamples] = {
...
const Float SpectrumBase::CIE_Y[nCIESamples] = {
...
const Float SpectrumBase::CIE_Z[nCIESamples] = {
...
const Float SpectrumBase::RGB2SpectLambda[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectWhite[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectCyan[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectMagenta[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectYellow[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectRed[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectGreen[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBRefl2SpectBlue[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectWhite[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectCyan[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectMagenta[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectYellow[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectRed[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectGreen[nRGB2SpectSamples] = {
...
const Float SpectrumBase::RGBIllum2SpectBlue[nRGB2SpectSamples] = {
