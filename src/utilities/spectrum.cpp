...
bool Spectrum::samplesAreSorted(const float *lambda, const float *vals, int n)
{
    for (int i = 0; i < n - 1; ++i)
...
void Spectrum::sortSamples(float *lambda, float *vals, int n) {
...
float Spectrum::interpolateSamples(const float *lambda, const float *vals, int n, float l)
{
...
void Spectrum::blackbody(const Float *lambda, int n, Float T, Float *Le)
{
    if (T <= 0) {
...
void Spectrum::blackbodyNormalized(const Float *lambda, int n, Float T, Float *Le) {
...
RGBSpectrum RGBSpectrum::fromSampled(const float *lambda, const float *v, int n)
{
    ...
    for (int i = 0; i < NUM_CIE_SAMPLES; ++i) {
        ...
        xyz[0] += val * Spectrum::CIE_X[i];
        xyz[1] += val * Spectrum::CIE_Y[i];
        xyz[2] += val * Spectrum::CIE_Z[i];
    }
...
const float Spectrum::CIE_LAMBDA[NUM_CIE_SAMPLES] = {
...
const float Spectrum::CIE_X[NUM_CIE_SAMPLES] = {
...
const float Spectrum::CIE_Y[NUM_CIE_SAMPLES] = {
...
const float Spectrum::CIE_Z[NUM_CIE_SAMPLES] = {
